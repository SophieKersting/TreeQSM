...
inputs.PatchDiam1 =  0.002; % beech 0.0075 % root 0.002 %default[0.08 0.12]
% Minimum patch size of the cover sets in the second cover:
inputs.PatchDiam2Min = 0.002; % beech 0.001 % root 0.002 %default[0.02 0.03]
% Maximum cover set size in the stem's base in the second cover:
inputs.PatchDiam2Max = 0.006; % beech [0.005 0.0075]; % root 0.004 %default[0.07 0.1]
...
inputs.BallRad1 = inputs.PatchDiam1+0.0015; % beech 0.002 % root 0.0018 %default 0.0015
% Maximum ball radius in the second cover generation:
inputs.BallRad2 = inputs.PatchDiam2Max+0.001; % beech 0.001(5) % root 0.0005 %default0.01
